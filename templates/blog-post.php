...
<?php if ( wp_get_attachment_image_url( get_post_thumbnail_id(), 'full' ) ): ?>
                    ...
                    <?php else: ?>
                        <h2 class="post-title" >Opps! No Post Found</h2>
                    <?php endif;?>
                </div>
                <div class="row my-3">
                            <div class="col-12">
                                <?php if ( $ascent['pagi_alin'] == 1 ): ?>
