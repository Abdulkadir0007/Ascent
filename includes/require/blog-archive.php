...
<?php if ( wp_get_attachment_image_url( get_post_thumbnail_id(), 'full' ) ): ?>
		                                            <div class="hovercover">
		                                                <a class="first-child"
		                                                    ...
		                                                    <div class="media-icon"><i class="fa-solid fa-magnifying-glass"></i>
		                                                    </div>
		                                                </a>
                            ...
                            <div class="col-12 my-3">
                                    <?php if ( $ascent['arpage_pagi_alin'] == 1 ): ?>
                                    ...
                                    <?php elseif ( $ascent['arpage_pagi_alin'] == 2 ): ?>
                                    ...
                                    <?php elseif ( $ascent['arpage_pagi_alin'] == 3 ): ?>
