            ...
            $('section').each(function () {
                ...
                if ($(this).attr('id')) {
                    ...
                    if (prop.windowPosition >= topEl && prop.windowPosition < elTopAndHeight) {
                        $(settings.itemHighlighter.item)
                            .removeClass(
                                settings.itemHighlighter.classToHighlight
                            )
                    ...
                    if (pageHeight == prop.docHeight) {
                        $(settings.itemHighlighter.item).removeClass(
                            settings.itemHighlighter.classToHighlight
                        );
                        $(settings.itemHighlighter.lastItem).addClass(
                            settings.itemHighlighter.classToHighlight
                        );
                    }
